...
@font-face {
  ...
  src: local("Pilat Wide Demi"), local("Pilat-Wide-Demi"),
    url("portfolio/portfolio/.vuepress/public/upload/PilatWide-Demi.woff") format("woff");
  font-weight: normal;
  font-style: normal;
}
...
@font-face {
  ...
  src: local("Pilat Book"), local("Pilat-Book"),
    url("portfolio/portfolio/.vuepress/public/upload/Pilat-Book.woff") format("woff");
  font-weight: normal;
  font-style: normal;
}
